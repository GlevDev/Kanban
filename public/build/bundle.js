...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$4, 218, 6, 5671);
    			add_location(p, file$4, 219, 6, 5707);
    			attr_dev(div, "id", "arrow");
    			attr_dev(div, "class", "svelte-1y6vt5b");
    			add_location(div, file$4, 220, 6, 5758);
    			add_location(section, file$4, 217, 4, 5654);
    		},
    		m: function mount(target, anchor) {
    ...
    // (202:6) {#each card.tasks as task, t (task.id)}
    function create_each_block_1(key_1, ctx) {
    	...
    	function task_value_binding(value) {
    		/*task_value_binding*/ ctx[16].call(null, value, /*i*/ ctx[21], /*t*/ ctx[24]);
    	}

    	let task_props = {
    		id: "t_" + /*task*/ ctx[22].id,
    		firstCard: /*i*/ ctx[21] === 0 || /*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value == "",
    		lastCard: /*i*/ ctx[21] === /*kanbanBoard*/ ctx[3].length - 1 || /*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value == ""
    	};

    	if (/*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value !== void 0) {
    		task_props.value = /*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value;
    	}

    	const task = new Task({ props: task_props, $$inline: true });
    	binding_callbacks.push(() => bind(task, "value", task_value_binding));
    	task.$on("deleteTask", /*deleteTask*/ ctx[8]);
    	task.$on("moveLeft", /*moveTaskLeft*/ ctx[9]);
    	task.$on("moveRight", /*moveTaskRight*/ ctx[10]);
    	task.$on("blurred", /*taskBlurred*/ ctx[11]);
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const task_changes = {};
    			if (dirty & /*kanbanBoard*/ 8) task_changes.id = "t_" + /*task*/ ctx[22].id;
    			if (dirty & /*kanbanBoard*/ 8) task_changes.firstCard = /*i*/ ctx[21] === 0 || /*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value == "";
    			if (dirty & /*kanbanBoard*/ 8) task_changes.lastCard = /*i*/ ctx[21] === /*kanbanBoard*/ ctx[3].length - 1 || /*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value == "";

    			if (!updating_value && dirty & /*kanbanBoard*/ 8) {
    				updating_value = true;
    				task_changes.value = /*kanbanBoard*/ ctx[3][/*i*/ ctx[21]].tasks[/*t*/ ctx[24]].value;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(202:6) {#each card.tasks as task, t (task.id)}",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			button = element("button");
    			t = text("+");
    			attr_dev(button, "id", button_id_value = "addTask_" + /*i*/ ctx[21]);
    			attr_dev(button, "class", "svelte-1y6vt5b");
    			add_location(button, file$4, 213, 8, 5552);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    			if (remount) dispose();
    			dispose = listen_dev(button, "click", /*addTask*/ ctx[7], false, false, false);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*kanbanBoard*/ 8 && button_id_value !== (button_id_value = "addTask_" + /*i*/ ctx[21])) {
    ...
    // (201:4) <Card id={'c_' + card.id} title={card.name} on:deleteCard={deleteCard}>
    function create_default_slot_2(ctx) {
    	let each_blocks = [];
    	let each_1_lookup = new Map();
    	let t;
    	let current;
    	let each_value_1 = /*card*/ ctx[19].tasks;
    	validate_each_argument(each_value_1);
    	const get_key = ctx => /*task*/ ctx[22].id;
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*kanbanBoard, deleteTask, moveTaskLeft, moveTaskRight, taskBlurred*/ 3848) {
    				const each_value_1 = /*card*/ ctx[19].tasks;
    				validate_each_argument(each_value_1);
    				group_outros();
    				validate_each_keys(ctx, each_value_1, get_each_context_1, get_key);
    			...
    			if (dirty & /*$$scope, kanbanBoard*/ 33554440) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(201:4) <Card id={'c_' + card.id} title={card.name} on:deleteCard={deleteCard}>",
    		ctx
    	});
    ...
    // (200:2) {#each kanbanBoard as card, i (card.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const card = new Card({
    			props: {
    				id: "c_" + /*card*/ ctx[19].id,
    				title: /*card*/ ctx[19].name,
    	...
    	card.$on("deleteCard", /*deleteCard*/ ctx[6]);
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*kanbanBoard*/ 8) card_changes.id = "c_" + /*card*/ ctx[19].id;
    			if (dirty & /*kanbanBoard*/ 8) card_changes.title = /*card*/ ctx[19].name;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(200:2) {#each kanbanBoard as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const card_changes = {};
    			if (dirty & /*newCardTitle*/ 2) card_changes.title = /*newCardTitle*/ ctx[1];

    			if (dirty & /*$$scope, newCardTitle, newCardInput*/ 33554438) {
    				card_changes.$$scope = { dirty, ctx };
    			}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(224:2) {#if newCardCreated}",
    		ctx
    	});
    ...
    // (225:4) <Card id="newCard" title={newCardTitle} newCard={true}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 225, 6, 5901);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, input, anchor);
    			set_input_value(input, /*newCardTitle*/ ctx[1]);
    			/*input_binding*/ ctx[18](input);
    			if (remount) run_all(dispose);

    			dispose = [
    				listen_dev(input, "input", /*input_input_handler*/ ctx[17]),
    				listen_dev(input, "blur", /*newCardAdded*/ ctx[5], false, false, false)
    			];
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*newCardTitle*/ 2 && input.value !== /*newCardTitle*/ ctx[1]) {
    				set_input_value(input, /*newCardTitle*/ ctx[1]);
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(225:4) <Card id=\\\"newCard\\\" title={newCardTitle} newCard={true}>",
    		ctx
    	});
    ...
    // (199:0) <Flex noWrap={true} align={'start'}>
    function create_default_slot(ctx) {
    	...
    	let current;
    	let dispose;
    	let each_value = /*kanbanBoard*/ ctx[3];
    	validate_each_argument(each_value);
    	const get_key = ctx => /*card*/ ctx[19].id;
    	...
    	let if_block = /*newCardCreated*/ ctx[0] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 234, 4, 6116);
    			add_location(section, file$4, 233, 2, 6101);
    		},
    		m: function mount(target, anchor, remount) {
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(target, anchor);
    			...
    			current = true;
    			if (remount) dispose();
    			dispose = listen_dev(button, "click", /*addCard*/ ctx[4], false, false, false);
    		},
    		p: function update(ctx, dirty) {
    			if (dirty & /*kanbanBoard, deleteCard, addTask, deleteTask, moveTaskLeft, moveTaskRight, taskBlurred*/ 4040) {
    				const each_value = /*kanbanBoard*/ ctx[3];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(199:0) <Flex noWrap={true} align={'start'}>",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, newCardTitle, newCardInput, newCardCreated, kanbanBoard*/ 33554447) {
    				flex_changes.$$scope = { dirty, ctx };
    			}
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function deleteCard(e) {
    		...
    		$$invalidate(3, kanbanBoard = kanbanBoard.filter(c => c.id !== cardId));
    	}
    	...
    	function deleteTask(e) {
    		...
    		$$invalidate(3, kanbanBoard[cardIndex].tasks = kanbanBoard[cardIndex].tasks.filter(t => t.id !== taskID), kanbanBoard);
    	}
    	...
    	function input_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			$$invalidate(2, newCardInput = $$value);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("newCardTitle" in $$props) $$invalidate(1, newCardTitle = $$props.newCardTitle);
    		if ("newCardInput" in $$props) $$invalidate(2, newCardInput = $$props.newCardInput);
    		if ("kanbanBoard" in $$props) $$invalidate(3, kanbanBoard = $$props.kanbanBoard);
    	};
