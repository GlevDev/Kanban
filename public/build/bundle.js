...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$4, 195, 6, 5292);
    			add_location(p, file$4, 196, 6, 5328);
    			attr_dev(div, "id", "arrow");
    			attr_dev(div, "class", "svelte-1y6vt5b");
    			add_location(div, file$4, 197, 6, 5379);
    			add_location(section, file$4, 194, 4, 5275);
    		},
    		m: function mount(target, anchor) {
    ...
    // (178:8) {#each card.tasks as task, t (task.id)}
    function create_each_block_1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(178:8) {#each card.tasks as task, t (task.id)}",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 189, 10, 5153);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    // (177:6) <Card id={'c_' + card.id} title={card.name} on:deleteCard={deleteCard}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(177:6) <Card id={'c_' + card.id} title={card.name} on:deleteCard={deleteCard}>",
    		ctx
    	});
    ...
    // (175:2) {#each $kanbanBoard as card, i (card.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(section, file$4, 175, 4, 4501);
    			this.first = section;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(175:2) {#each $kanbanBoard as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(201:2) {#if newCardCreated}",
    		ctx
    	});
    ...
    // (202:4) <Card id="newCard" title={newCardTitle} newCard={true}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 202, 6, 5522);
    		},
    		m: function mount(target, anchor, remount) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(202:4) <Card id=\\\"newCard\\\" title={newCardTitle} newCard={true}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 212, 6, 5774);
    			add_location(section, file$4, 211, 4, 5749);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, section, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(211:2) {#if !hideAddCardBtn}",
    		ctx
    	});
    ...
    // (174:0) <Flex noWrap={true} align={'start'}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(174:0) <Flex noWrap={true} align={'start'}>",
    		ctx
    	});
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	let $kanbanBoard;
    	validate_store(kanbanBoard, "kanbanBoard");
    	component_subscribe($$self, kanbanBoard, $$value => $$invalidate(4, $kanbanBoard = $$value));
