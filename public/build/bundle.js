...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$4, 229, 6, 6039);
    			add_location(p, file$4, 230, 6, 6075);
    			attr_dev(div, "id", "arrow");
    			attr_dev(div, "class", "svelte-1y6vt5b");
    			add_location(div, file$4, 231, 6, 6126);
    			add_location(section, file$4, 228, 4, 6022);
    		},
    		m: function mount(target, anchor) {
    ...
    // (212:8) {#each card.tasks as task, t (task.id)}
    function create_each_block_1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(212:8) {#each card.tasks as task, t (task.id)}",
    		ctx
    	});
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 223, 10, 5900);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, button, anchor);
    			append_dev(button, t);
    ...
    // (211:6) <Card id={'c_' + card.id} title={card.name} on:deleteCard={deleteCard}>
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(211:6) <Card id={'c_' + card.id} title={card.name} on:deleteCard={deleteCard}>",
    		ctx
    	});
    ...
    // (209:2) {#each kanbanBoard as card, i (card.id)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(section, file$4, 209, 4, 5252);
    			this.first = section;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, section, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(209:2) {#each kanbanBoard as card, i (card.id)}",
    		ctx
    	});
    ...
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(235:2) {#if newCardCreated}",
    		ctx
    	});
    ...
    // (236:4) <Card id="newCard" title={newCardTitle} newCard={true}>
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 236, 6, 6269);
    		},
    		m: function mount(target, anchor, remount) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(236:4) <Card id=\\\"newCard\\\" title={newCardTitle} newCard={true}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 246, 6, 6521);
    			add_location(section, file$4, 245, 4, 6496);
    		},
    		m: function mount(target, anchor, remount) {
    			insert_dev(target, section, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(245:2) {#if !hideAddCardBtn}",
    		ctx
    	});
    ...
    // (208:0) <Flex noWrap={true} align={'start'}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(208:0) <Flex noWrap={true} align={'start'}>",
    		ctx
    	});
